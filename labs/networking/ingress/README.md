...
1. Remove public IP addresses for services
    ...
    helm upgrade service-tracker-ui ~/Kubernetes-Best-Practices/charts/service-tracker-ui --set service.type=ClusterIP
    ```
...
3. Setup DNS for ingress controller
    ...
    * Set permissions on the script
        ...
        ```bash
        chmod +x ~/Kubernetes-Best-Practices/labs/networking/ingress/configure-publicip-dns.sh
        ```
...
4. Generate TLS certificates
    ...
    -out ~/Kubernetes-Best-Practices/labs/networking/ingress/aks-ingress-tls.crt \
    -keyout ~/Kubernetes-Best-Practices/labs/networking/ingress/aks-ingress-tls.key \
...
5. Create a secret to store TLS cert
    ...
    --key ~/Kubernetes-Best-Practices/labs/networking/ingress/aks-ingress-tls.key \
    --cert ~/Kubernetes-Best-Practices/labs/networking/ingress/aks-ingress-tls.crt -n hackfest
    ```
...
6. Create an ingress route
    ...
    * Apply
        ...
        ```bash
        kubectl apply -f ~/Kubernetes-Best-Practices/labs/networking/ingress/service-tracker-ingress.yaml -n hackfest
        ```
